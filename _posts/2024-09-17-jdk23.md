...
-   __New SecureRandom() performance improved__
    ...
    The performance of constructing a [`java.security.SecureRandom`](https://docs.oracle.com/en/java/javase/23/docs/api/java.base/java/security/SecureRandom.html) via `new SecureRandom()`
    has been improved.
