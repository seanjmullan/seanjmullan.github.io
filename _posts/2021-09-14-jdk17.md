...
- [JEP 409: Sealed Classes](https://openjdk.java.net/jeps/409)
  ...
  Sealed classes allow you to restrict what classes, if any, are allowed to
...
-   __Deprecate the Security Manager for Removal__
    ...
    to the Security Manager -- see the JEP for a full list of impacted APIs.

    There are several reasons why the Security Manager is being deprecated,
    and these are covered in more detail in JEP 411.
