...
-   __New root CA certificates__
    ...
    1. Three eMudhra Technologies root CA certificates
    ...
    2. Four DigiCert root CA certificates
    ...
    3. [Let's Encrypt ISRG Root X2](https://crt.sh/?caid=183269) has the following distinguished name:
    ...
    4. [Telia Root CA v2](https://crt.sh/?caid=109075) has the following distinguished name:
    ...
    5. [Certigna Root CA](https://crt.sh/?caid=18456) has the following distinguished name:
