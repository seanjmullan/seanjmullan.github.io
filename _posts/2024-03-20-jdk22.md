...
-   __keytool and jarsigner support for the HSS/LMS signature algorithm__   
    ...
    ---
        $ keytool -genkeypair -alias Duke -dname CN="Duke" -keystore <keystore> \
          -keyalg HSS/LMS -groupname LMS_SHA256_M24_H5,LMOTS_SHA256_N24_W1,LMS_SHA256_M24_H5,LMOTS_SHA256_N24_W1
