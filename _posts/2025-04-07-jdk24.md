...
quantum-resistant cryptographic algorithms, ML-KEM for Key Encapsulation, and
ML-DSA for Digital Signatures. It also includes a new Preview API for Key
Derivation Functions, which will be an important building block for subsequent
Post-Quantum Cryptography work. Also in this release the Security Manager is
now permanently disabled.

One other important JDK 24 feature that improves security but is not part of
the security libraries area is:
...
-   __JEP 496: Quantum-Resistant Module-Lattice-Based Key Encapsulation Mechanism__
    ...
    ![ML-KEM keytool command](/images/ML-KEM-keytool.jpg)
...
-   __JEP 497: Quantum-Resistant Module-Lattice-Based Digital Signature Algorithm__
    ...
    ![ML-DSA keytool command](/images/ML-DSA-keytool.jpg)
